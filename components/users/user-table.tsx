...
import type { AuthRole, SerializedUser } from "@/features/users/types";
...
export function UserTable({ initialUsers }: UserTableProps) {
	...
	const filtered = useMemo(() => {
		...
		return users.filter((u) => {
			...
			const matchRole = roleFilter === "ALL" || u.authRole === roleFilter;
	...
	const columns: GridColDef[] = [
...

		{
			...
			renderCell: (params) => (
				<RoleBadge
					role={params.row.disabled ? "STOCK_USER" : params.row.authRole}
				/>
			),
		},
