...
import type { ActionResult, UpdateUserInput, User, UserRole } from "./types";
...
export async function assignUserRoleService(userId: string, role: UserRole) {
	await updateUserRoleRepository(userId, role);
}
